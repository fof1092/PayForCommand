...
import me.F_o_F_1092.PayForCommand.Options;
...
public class HelpMessage {
	...
	public HelpMessage(String commandString, String commandColloredString, String helpMessage) {
		...
		//if (VersionManager.getServerType() == ServerType.BUKKIT) {
			this.jsonHelpMessage = me.F_o_F_1092.PayForCommand.PluginManager.Spigot.JSONMessageListener.putJSONMessagesTogether(jsonMessages);
